    ...
    paths: {
        ...
        "/organizations": {
            ...
            get: {
                ...
                responses: {
                    200: {
                        description: "List of user organizations retrieved successfully",
                        content: {
                            "application/json": {
                                schema: {
                                    type: "array",
        ...
        "/organizations/{orgId}/members": {
            get: {
                summary: "List all members of an organization (tenant)",
                tags: ["Organizations"],
                security: [{ bearerAuth: [] }],
                ...
                responses: {
                    ...
                    403: { description: "Forbidden - cross-tenant access blocked" },
                },
            },
        },
        "/projects": {
